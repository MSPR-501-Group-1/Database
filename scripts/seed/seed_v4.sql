...
-- user_
-- ============================================================
INSERT INTO user_ (user_id, email, password_hash, first_name, last_name, birth_date, gender_code, created_at, is_active, role_type) VALUES
  ('USR_001', 'alice.martin@email.com',   crypt('Password1!', gen_salt('bf')), 'Alice',   'Martin',   '1990-04-15', 1, '2024-03-01', TRUE,  'PREMIUM'),
  ('USR_002', 'bob.dupont@email.com',     crypt('Password2!', gen_salt('bf')), 'Bob',     'Dupont',   '1985-08-22', 1, '2024-04-10', TRUE,  'FREEMIUM'),
  ('USR_003', 'claire.leroy@email.com',   crypt('Password3!', gen_salt('bf')), 'Claire',  'Leroy',    '1995-12-05', 2, '2024-05-20', TRUE,  'PREMIUM_PLUS'),
  ('USR_004', 'david.petit@email.com',    crypt('Password4!', gen_salt('bf')), 'David',   'Petit',    '1992-06-30', 1, '2024-06-15', TRUE,  'B2B'),
  ('USR_005', 'emma.blanc@email.com',     crypt('Password5!', gen_salt('bf')), 'Emma',    'Blanc',    '1998-02-14', 2, '2024-07-01', TRUE,  'PREMIUM'),
  ('USR_006', 'francois.noir@email.com',  crypt('Password6!', gen_salt('bf')), 'François','Noir',     '1988-09-17', 1, '2024-08-05', FALSE, 'FREEMIUM'),
  ('USR_007', 'admin@healthapp.com',      crypt('AdminPass!', gen_salt('bf')), 'Admin',   'System',   '1980-01-01', 1, '2023-01-01', TRUE,  'ADMIN');
