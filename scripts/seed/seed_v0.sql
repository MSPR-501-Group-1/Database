...
INSERT INTO exercise (exercise_id, name, body_part_target, video_url, description, difficulty_level, equipment_required, category) VALUES
  ...
  ('EXC_004', 'Running',         'Full Body',   'https://videos.example.com/running',     'Steady-state cardio session',                'BEGINNER',     'Shoes',        'CARDIO'),
  ...
  ('EXC_007', 'Yoga Flow',       'Full Body',   'https://videos.example.com/yoga',        'Dynamic flexibility and breathing sequence', 'BEGINNER',     'Yoga mat',     'FLEXIBILITY'),
  ('EXC_008', 'Burpee',          'Full Body',   'https://videos.example.com/burpee',      'High-intensity full body conditioning',      'INTERMEDIATE', 'None',         'CARDIO'),
  ...
  ('EXC_010', 'Jump Rope',       'Full Body',   'https://videos.example.com/jumprope',    'High-intensity cardiovascular drill',        'BEGINNER',     'Jump rope',    'CARDIO');
...
INSERT INTO user_profile (user_id, height_cm, current_weight_kg, activity_level_ref, allergies, diet_type, updated_at, goal_id) VALUES
  ('UP_001', 1.81, 78.50, 'ACTIVE',       'NONE',   'NONE',       '2025-01-14 08:00:00', 'GOAL_002'),
  ('UP_002', 1.65, 62.00, 'MODERATE',     'MILK',   'VEGETARIAN', '2025-01-13 09:00:00', 'GOAL_001'),
  ('UP_003', 1.75, 95.20, 'SEDENTARY',    'GLUTEN', 'NONE',       '2025-01-12 10:00:00', 'GOAL_001'),
  ('UP_004', 1.70, 55.00, 'VERY_ACTIVE',  'NONE',   'VEGAN',      '2025-01-11 11:00:00', 'GOAL_003'),
  ('UP_005', 1.68, 71.00, 'ACTIVE',       'NUTS',   'KETO',       '2025-01-10 12:00:00', 'GOAL_005'),
  ('UP_006', 1.82, 85.00, 'MODERATE',     'NONE',   'NONE',       '2025-01-09 08:00:00', 'GOAL_004'),
  ('UP_007', 1.60, 58.00, 'ACTIVE',       'SOY',    'PESCATARIAN','2025-01-08 09:00:00', 'GOAL_002');

-- ============================================================
-- user_
-- ============================================================
INSERT INTO user_ (user_id, email, password_hash, first_name, last_name, birth_date, gender_code, created_at, is_active, role_code, role_id, user_id_1) VALUES
  ('USR_001', 'alice.martin@email.com',   crypt('Password1!', gen_salt('bf')), 'Alice',   'Martin',   '1990-04-15', 1, '2024-03-01', TRUE,  'PREMIUM',      'ROLE_02', 'UP_001'),
  ('USR_002', 'bob.dupont@email.com',     crypt('Password2!', gen_salt('bf')), 'Bob',     'Dupont',   '1985-08-22', 1, '2024-04-10', TRUE,  'FREEMIUM',     'ROLE_01', 'UP_002'),
  ('USR_003', 'claire.leroy@email.com',   crypt('Password3!', gen_salt('bf')), 'Claire',  'Leroy',    '1995-12-05', 2, '2024-05-20', TRUE,  'PREMIUM_PLUS', 'ROLE_03', 'UP_003'),
  ('USR_004', 'david.petit@email.com',    crypt('Password4!', gen_salt('bf')), 'David',   'Petit',    '1992-06-30', 1, '2024-06-15', TRUE,  'B2B',          'ROLE_04', 'UP_004'),
  ('USR_005', 'emma.blanc@email.com',     crypt('Password5!', gen_salt('bf')), 'Emma',    'Blanc',    '1998-02-14', 2, '2024-07-01', TRUE,  'PREMIUM',      'ROLE_02', 'UP_005'),
  ('USR_006', 'francois.noir@email.com',  crypt('Password6!', gen_salt('bf')), 'François','Noir',     '1988-09-17', 1, '2024-08-05', FALSE, 'FREEMIUM',     'ROLE_01', 'UP_006'),
  ('USR_007', 'admin@healthapp.com',      crypt('AdminPass!', gen_salt('bf')), 'Admin',   'System',   '1980-01-01', 1, '2023-01-01', TRUE,  'ADMIN',        'ROLE_05', 'UP_007');
